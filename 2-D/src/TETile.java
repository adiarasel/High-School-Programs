...
public class TETile implements Serializable {
     ...
     * @param icon            The character or icon displayed on the screen
     */
    public TETile(Color textColor,
                  Color backgroundColor, String description, String filepath, String icon) {
     ...
     * @param backgroundColor The color drawn behind the character.
     * @param description The description of the tile, shown in the GUI on hovering over the tile.
     * @param icon The actual character displayed on the screen
     */
    public TETile(Color textColor,
                  Color backgroundColor, String description, String icon) {
        this.textColor = textColor;
        this.backgroundColor = backgroundColor;
        this.description = description;
        this.filepath = null;
    ...
    public TETile(TETile t, Color textColor) {
        this(
                t.textColor, t.backgroundColor, t.description,
                t.filepath,
                t.icon);
    }
    ...
    // The following two methods should be changed for your individual use case
    ...
    public boolean equals(Object o) {
        if (o instanceof TETile) {
            return description.equals(((TETile) o).description);
        }
        return false;
    }

    /**
     * Returns the string version of a tile
     * @return stringified tile
     **/
    @Override
